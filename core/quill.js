...
class Quill {
  ...
  /**
   * this.container 去获取的 <dic id="edit"> 的 dom 元素也就是编辑器
   * 将编辑器的 dom 节点存放在 let html 中
   * 
   *  
   */
  constructor(container, options = {}) {
    ...
    // 如果由占位符 则设置 root 元素的 <div class="ql-editor" data-placeholder="this.options.placeholder">
